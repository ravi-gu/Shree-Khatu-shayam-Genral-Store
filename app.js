...
function initAuth(){ if(currentUser){KEY='SKS_STORE_DATA_'+currentUser; loadUserData(); startApp();} else {authScreen.style.display='flex'; appContent.style.display='none';}}
